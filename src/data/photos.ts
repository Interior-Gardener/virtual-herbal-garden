...
export const PLANT_PHOTOS: Record<string, PlantPhoto[]> = {
  ...
  lotus: [
    {
      src: '/photos/lotus-1.jpg',
      alt: 'A tank full of lotus in flower',
      credit: 'J. Patrick Fischer',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:20240819_171042_Beijing.jpg',
    },
    {
      src: '/photos/lotus-2.jpg',
      alt: 'The flower, pink and white forms together',
      credit: 'Didier Descouens',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:(MHNT)_Les_Martels,_Giroussens_Tarn_-_%27Nelumbo_nucifera%27.jpg',
    },
    {
      src: '/photos/lotus-3.jpg',
      alt: 'Seed heads on the receptacle, the part eaten and used',
      credit: '663highland',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:250712_Mizunomori_Water_Botanical_Garden_Kusatsu_Shiga_pref_Japan29s3.jpg',
    },
  ],
  sadaphuli: [
    {
      src: '/photos/sadaphuli-1.jpg',
      alt: 'Sadaphuli sprawling on dry red ground',
      credit: 'imbeaul',
      license: 'CC BY 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:2019-08-02_Catharanthus_roseus,_Ifaty,_Madagascar_1.jpg',
    },
    {
      src: '/photos/sadaphuli-2.jpg',
      alt: 'Flowers with the darker eye',
      credit: 'imbeaul',
      license: 'CC BY 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:2019-08-02_Catharanthus_roseus,_Ifaty,_Madagascar_3.jpg',
    },
    {
      src: '/photos/sadaphuli-3.jpg',
      alt: 'The glossy opposite leaves and a flower',
      credit: 'Md Mobashir Hossain',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:A_flower_with_an_Ant.jpg',
    },
  ],
  pomegranate: [
    {
      src: '/photos/pomegranate-1.jpg',
      alt: 'A pomegranate tree in the open',
      credit: 'יעקב',
      license: 'Public domain',
      source: 'https://commons.wikimedia.org/wiki/File:Punica_granatum_with_fruit_in_august.JPG',
    },
    {
      src: '/photos/pomegranate-2.jpg',
      alt: 'The scarlet flower with its thick calyx',
      credit: 'Tulsi Bhagat',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:Punica_granatum_flower_(1).jpg',
    },
    {
      src: '/photos/pomegranate-3.jpg',
      alt: 'Ripe fruit on the branch',
      credit: 'DGtal',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:Cracked_pomegranate_on_a_tree.jpg',
    },
  ],
  babul: [
    {
      src: '/photos/babul-1.jpg',
      alt: 'A babul tree beside a field track',
      credit: 'Sonu020',
      license: 'CC0',
      source: 'https://commons.wikimedia.org/wiki/File:Acacia_nilotica_(indian_babul_tree_with_full_blown_flowers).jpg',
    },
    {
      src: '/photos/babul-2.jpg',
      alt: 'Yellow flower heads, with the paired white thorns',
      credit: 'Dinesh Valke from Thane, India',
      license: 'CC BY-SA 2.0',
      source: 'https://commons.wikimedia.org/wiki/File:Acacia_nilotica_ssp._indica_(517652060).jpg',
    },
    {
      src: '/photos/babul-3.jpg',
      alt: 'The necklace-like pods',
      credit: 'JMK',
      license: 'CC BY-SA 3.0',
      source: 'https://commons.wikimedia.org/wiki/File:Acacia_nilotica,_peule,_a,_Uniegeboutuine.jpg',
    },
  ],
  hibiscus: [
    {
      src: '/photos/hibiscus-1.jpg',
      alt: 'Jaswand grown as a hedge',
      credit: 'Photo by David J. Stang',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:Hibiscus_rosa-sinensis_17zz.jpg',
    },
    {
      src: '/photos/hibiscus-2.jpg',
      alt: 'The red flower, staminal column well beyond the petals',
      credit: 'Gabriel De Aza',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:Hibiscus_rosa_-sinensis.jpg',
    },
    {
      src: '/photos/hibiscus-3.jpg',
      alt: 'The coarsely toothed leaf',
      credit: 'Gazal world',
      license: 'CC BY-SA 4.0',
      source: 'https://commons.wikimedia.org/wiki/File:Hibiscus_rosa-sinensis_leaf.jpg',
    },
  ],
}
